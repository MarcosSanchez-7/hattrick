 ...
 * JSON-LD. Se toma de una env var para no repetir el dominio en cada
 * archivo — cambiar un solo valor actualiza todo lo que depende de una URL
 * absoluta.
 */
export const SITE_URL = (
  process.env.NEXT_PUBLIC_SITE_URL ?? "https://www.hattrickpy.com"
).replace(/\/$/, "");
